		...
		<?php foreach ($categorias as $categoria) { 
  		...
  		?>
			...
			<td class="p-4 border-b border-slate-200 relative">
				...
				<a href="index.php?seccion=delete_categoria&id=<?= $categoria->getId() ?>" class="btn relative h-10 max-h-[40px] w-10 max-w-[40px] select-none rounded-lg text-center align-middle font-sans text-xs font-medium uppercase text-slate-900 transition-all hover:bg-slate-900/10 active:bg-slate-900/20 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none">
				...
				<a href="index.php?seccion=edit_categoria&id=<?= $categoria->getId() ?>" class="btn relative h-10 max-h-[40px] w-10 max-w-[40px] select-none rounded-lg text-center align-middle font-sans text-xs font-medium uppercase text-slate-900 transition-all hover:bg-slate-900/10 active:bg-slate-900/20 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none">
				<span class="absolute transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
