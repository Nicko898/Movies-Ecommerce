		...
		<table>
			<thead>
				<tr>
					...
					<th>Descripción</th>
					<th>
						<a href="index.php?seccion=add_categoria" class="export-btn">
			...
			<?php foreach ($categorias as $categoria) { ?>
				<tr>
                    ...
                    <td>
					<a href="index.php?seccion=edit_categoria&id=<?= $categoria->getId() ?>" class="export-btn">
					...
					<a href="index.php?seccion=delete_categoria&id=<?= $categoria->getId() ?>" class="export-btn mt-3">
