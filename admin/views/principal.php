<main class="py-6 px-12 space-y-12 bg-gray-100 min-h-screen w-full">
	<section class="grid grid-cols-4 bg-white divide-x w-full rounded-lg">
		...
		<div class="flex px-8 py-5 cursor-pointer text-gray-900 items-center hover:bg-gray-100 bg-blue-50 border-b border-l-gray-100 border-b-blue-500 border-b-4">
		...
		<section class="flex flex-col mx-auto bg-white rounded-lg p-6 shadow-md space-y-6 w-full">
			<div class="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
				...
				<div class="col-span-1 flex items-center">
					<button class="relative  px-4 py-2 rounded w-80 items-center justify-center bg-blue-500 text-white font-medium hover:bg-primary-900">
                        New facility
                    </button>
				</div>
			</div>
